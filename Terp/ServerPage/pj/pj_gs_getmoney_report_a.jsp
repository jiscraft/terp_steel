	...
	try {
		...
		while (iterator.hasNext()) {
			...
			if (tcf.getJsonValueSimple("object", jsonObject, "actiondata").toString().equals("period")) {
				queryString = queryString + "exec usp_pj_gs_getmoney_report_a 'period' ";
				...
				queryString = queryString + ", @p_fg_statusString2 = " + tcf.getJsonValueSimple("string", jsonObject, "fg_statusString2");

			}

			if (tcf.getJsonValueSimple("object", jsonObject, "actiondata").toString().equals("site")) {
				queryString = queryString + "exec usp_pj_gs_getmoney_report_a 'site' ";
				queryString = queryString + ", @p_id_user = " + tcf.getJsonValueSimple("string", jsonObject, "loginIduser");
				queryString = queryString + ", @p_cd_c = " + tcf.getJsonValueSimple("string", jsonObject, "loginCdc");
				queryString = queryString + ", @p_cd_site = " + tcf.getJsonValueSimple("string", jsonObject, "cd_site");
				queryString = queryString + ", @p_cd_p = " + tcf.getJsonValueSimple("string", jsonObject, "cd_p");
			...
			if (tcf.getJsonValueSimple("object", jsonObject, "actiondata").toString().equals("overgm")) {
				queryString = queryString + "exec usp_pj_gs_getmoney_report_a 'overgm' ";
				queryString = queryString + ", @p_id_user = " + tcf.getJsonValueSimple("string", jsonObject, "loginIduser");
				queryString = queryString + ", @p_cd_c = " + tcf.getJsonValueSimple("string", jsonObject, "loginCdc");
				queryString = queryString + ", @p_cd_site = " + tcf.getJsonValueSimple("string", jsonObject, "cd_site");
				queryString = queryString + ", @p_cd_p = " + tcf.getJsonValueSimple("string", jsonObject, "cd_p");
			...
			if (tcf.getJsonValueSimple("object", jsonObject, "actiondata").toString().equals("m")) {
				queryString = queryString + "exec usp_pj_gs_getmoney_report_a 'm' ";
				queryString = queryString + ", @p_id_user = " + tcf.getJsonValueSimple("string", jsonObject, "loginIduser");
				queryString = queryString + ", @p_cd_c = " + tcf.getJsonValueSimple("string", jsonObject, "loginCdc");
				queryString = queryString + ", @p_cd_site = " + tcf.getJsonValueSimple("string", jsonObject, "cd_site");
				queryString = queryString + ", @p_cd_p = " + tcf.getJsonValueSimple("string", jsonObject, "cd_p");
