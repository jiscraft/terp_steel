...
<%
    ...
    try {
        ...
        while (iterator.hasNext()) {
            ...
            queryString = "";
            queryString = queryString + "exec usp_sy_erp_msg_selectid 'r' ";
            ...
            queryString = queryString + ", @p_dt_insert_fr = " + tcf.getJsonValueSimple("string", jsonObject, "dt_insert_fr");
            queryString = queryString + ", @p_dt_insert_to = " + tcf.getJsonValueSimple("string", jsonObject, "dt_insert_to");
