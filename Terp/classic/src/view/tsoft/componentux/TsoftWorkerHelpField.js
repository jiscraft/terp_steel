/**
 * Created by asus on 2016-05-29.
 */
Ext.define('Terp.view.tsoft.componentux.TsoftWorkerHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftworkerhelpfield',
    requires: [
    ...
    callbackPopup : function(params) {
        this.setDisplayValue(params.nm_w);
        this.setRealValue(params.cd_w);
        this.setValue(params.cd_w);
        this.setRawValue(params.nm_w);
