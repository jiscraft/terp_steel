 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftVacationHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftvacationhelpfield',
    requires: [
        'Terp.view.tsoft.help.vacationhelp.TsoftVacationHelp'
    ],
    config:{
        displayValue :'' ,
        realValue :'' ,
    ...
    triggers: {
        search: {
            ...
            handler: function () {
                ...
                var pop = Ext.create('Terp.view.tsoft.help.vacationhelp.TsoftVacationHelp');
                pop.show();
