 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftPoHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftpohelpfield',

    requires: [
        'Terp.view.tsoft.help.pohelp.TsoftPoHelp'
    ],
    ...
    triggers: {
        search: {
            ...
            handler: function () {
                ...
                var pop = Ext.create('Terp.view.tsoft.help.pohelp.TsoftPoHelp',{
