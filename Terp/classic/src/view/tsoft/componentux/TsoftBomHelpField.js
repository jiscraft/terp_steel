 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftBomHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftbomhelpfield',
    ...
    callbackPopup : function(params) {
        this.setDisplayValue(params.nm_bom);
        this.setRealValue(params.cd_bom);
        this.setValue(params.cd_bom);
        this.setRawValue(params.nm_bom);
