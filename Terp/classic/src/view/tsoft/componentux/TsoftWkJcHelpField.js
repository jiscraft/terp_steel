 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftWkJcHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftwkjchelpfield',
    requires: [
        'Terp.view.tsoft.help.wkjchelp.TsoftWkJcHelp'
    ],
    ...
    triggers: {
        search: {
            ...
            handler: function () {
                var pop = Ext.create('Terp.view.tsoft.help.wkjchelp.TsoftWkJcHelp', {
                    aproCompleted: this.aproCompleted,
                    onlyOwner: this.onlyOwner,
                    fgWk030: this.fgWk030,
