 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftCrHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftcrhelpfield',

    requires: [
        'Terp.view.tsoft.help.crhelp.TsoftCrHelp'
    ],
    ...
    triggers: {
        search: {
            ...
            handler: function () {
                ...
                var pop = Ext.create('Terp.view.tsoft.help.crhelp.TsoftCrHelp', {
    ...
    callbackPopup : function(params) {
        this.setDisplayValue(params.no_cr);
        this.setRealValue(params.no_cr);
        this.setValue(params.no_cr);
        this.setRawValue(params.no_cr);
