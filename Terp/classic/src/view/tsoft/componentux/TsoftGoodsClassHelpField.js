 ...
 */
Ext.define('Terp.view.tsoft.componentux.TsoftGoodsClassHelpField', {
    extend: 'Ext.form.TextField',
    xtype: 'tsoftgoodsclasshelphelpfield',

    requires: [
        'Terp.view.tsoft.help.goodsclasshelp.TsoftGoodsClassHelp'
    ],
    ...
    triggers: {
        search: {
            ...
            handler: function () {
                ...
                var pop = Ext.create('Terp.view.tsoft.help.goodsclasshelp.TsoftGoodsClassHelp');
                pop.show();
    ...
    callbackPopup : function(params) {
        this.setDisplayValue(params.nm_goods_class);
        this.setRealValue(params.cd_goods_class);
        this.setValue(params.cd_goods_class);
        this.setRawValue(params.nm_goods_class);
