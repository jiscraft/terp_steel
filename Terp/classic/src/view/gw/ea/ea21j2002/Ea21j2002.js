 ...
 */
Ext.define('Terp.view.gw.ea.ea21j2002.Ea21j2002', {
    ...
    requires: [
        ...
        'Terp.view.gw.ea.ea21j2002.Ea21j2002Controller',
        'Terp.view.gw.ea.ea21j2002.Ea21j2002Model',
    ...
    items: [
        {
            ...
            reference: 'ea21j2002_headbutton'
        },
        {
            xtype: 'tsoftsearchform',
            reference: 'ea21j2002_searchform',
            scrollable: true,
            defaults: {
                width: 200,
                labelWidth: 60,
        ...
        {
            xtype: 'eadocgrid',
            reference: 'ea21j2002_eadoc_grid',
            title: '결재할 문서',
            bind: {
                store: '{ea_doc_store}'
            },
        ...
        {
            xtype: 'tsofttabpanel',
            reference: 'ea21j2002_tabpanel',
            flex: 1,
            margin: '5 0 0 0',
            items: [
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2002_tp1',
                    title: '결재',
                    aproType: '1'
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2002_tp2',
                    title: '합의',
                    aproType: '2'
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2002_tp3',
                    title: '협의',
                    aproType: '3',
                    hidden : true
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2002_tp9',
                    title: '수신',
                    aproType: '9'
                },
                {
                    xtype: 'tsoftpanel',
                    reference: 'ea21j2002_attach_tp',
                    title: '첨부',
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
                    ...
                    items: [
                        {
                            ...
                            reference: 'ea21j2002_attach_grid',
                            title : '첨부파일',
                            hiddenTools: 'all',
