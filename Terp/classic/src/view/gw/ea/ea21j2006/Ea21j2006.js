 ...
 */
Ext.define('Terp.view.gw.ea.ea21j2006.Ea21j2006', {
    ...
    requires: [
        ...
        'Terp.view.gw.ea.ea21j2006.Ea21j2006Controller',
        'Terp.view.gw.ea.ea21j2006.Ea21j2006Model',
    ...
    items: [
        ...
        },
        {
            ...
            reference: 'ea21j2006_searchform',
            scrollable: true,
            defaults: {
                width: 200,
                labelWidth: 60,
        ...
        {
            xtype: 'eadocgrid',
            reference: 'ea21j2006_eadoc_grid',
            title: '수신한 문서',
            bind: {
                store: '{ea_doc_store}'
            },
        ...
        {
            xtype: 'tsofttabpanel',
            reference: 'ea21j2006_tabpanel',
            flex: 1,
            margin: '5 0 0 0',
            items: [
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2006_tp1',
                    title: '결재',
                    aproType: '1'
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2006_tp2',
                    title: '합의',
                    aproType: '2'
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2006_tp3',
                    title: '협의',
                    aproType: '3',
                    hidden : true
                },
                {
                    xtype: 'eaaprogridtp',
                    reference: 'ea21j2006_tp9',
                    title: '수신',
                    aproType: '9'
                },
                {
                    xtype: 'tsoftpanel',
                    reference: 'ea21j2006_attach_tp',
                    title: '첨부',
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
                    ...
                    items: [
                        {
                            ...
                            reference: 'ea21j2006_attach_grid',
                            title : '첨부파일',
                            hiddenTools: 'all',
