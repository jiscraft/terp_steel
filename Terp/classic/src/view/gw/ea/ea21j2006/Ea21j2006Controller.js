 ...
 */
Ext.define('Terp.view.gw.ea.ea21j2006.Ea21j2006Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ea21j2006',

    control: {
        'ea21j2006': {
            boxready: 'onBoxReady_ea21j2006'
        },
        'tsoftheadbuttons[reference=ea21j2006_headbutton]': {
            boxready: 'onBoxReady_ea21j2006_headbutton'
        },
        'tsoftsearchform[reference=ea21j2006_searchform]': {
            boxready: 'onBoxReady_ea21j2006_searchform'
        },
        'eadocgrid[reference=ea21j2006_eadoc_grid]': {
            boxready: 'onBoxReady_ea21j2006_eadoc_grid',
            beforeselect: 'onBeforeSelect_ea21j2006_eadoc_grid',
            selectionchange: 'onSelectionChange_ea21j2006_eadoc_grid',
            itemdblclick: 'onItemDblClick_ea21j2006_eadoc_grid'
        },
        'eaaprogridtp[reference=ea21j2006_tp1] tsoftgrid[reference=eaaprogridtp_apro_grid]': {
            beforeselect: 'onBeforeSelect_eaaprogridtp_apro_grid',
            selectionchange: 'onSelectionChange_eaaprogridtp_apro_grid'
        },
        'eaaprogridtp[reference=ea21j2006_tp2] tsoftgrid[reference=eaaprogridtp_apro_grid]': {
            beforeselect: 'onBeforeSelect_eaaprogridtp_apro_grid',
            selectionchange: 'onSelectionChange_eaaprogridtp_apro_grid'
        }
    },
    ...
    init: function () {
        ...
        me.searchform = me.lookupReference('ea21j2006_searchform');
        me.eadoc_grid = me.lookupReference('ea21j2006_eadoc_grid');

        me.apro_tab_panel = me.lookupReference('ea21j2006_tabpanel');
        me.apro_tp1 = me.lookupReference('ea21j2006_tp1');
        me.apro_tp2 = me.lookupReference('ea21j2006_tp2');
        me.apro_tp3 = me.lookupReference('ea21j2006_tp3');
        me.apro_tp9 = me.lookupReference('ea21j2006_tp9');
        me.attach_grid = me.lookupReference('ea21j2006_attach_grid');
    ...
    onBoxReady_ea21j2006: function (p) {
        var me = this;
        me.onSelect();
    },

    onBoxReady_ea21j2006_headbutton: function (p) {
        var me = this;
    ...
    onBoxReady_ea21j2006_searchform: function (p) {
        var me = this;
    },

    onBoxReady_ea21j2006_eadoc_grid: function(g) {
        var me = this;
    },

    onBeforeSelect_ea21j2006_eadoc_grid: function(rowModel, record, index, eOpts) {
        var me = this;
        me.clearTpStores();
    },

    onSelectionChange_ea21j2006_eadoc_grid: function(selModel, selected) {
        var me = this;
    ...
    onItemDblClick_ea21j2006_eadoc_grid: function(obj, record) {
        var me = this;
